...
columns_ob = {
    ...
    1:[
        {"Variables": "y1", "Parametros": "p1", "Ecuaciones": 'dy1dt = p1 * (27.8 - y1) +'
                                                              ...
                                                              'math.exp(-0.5*(math.log(t) - p2 / p3))', "Condiciones Iniciales": "y(0.1)=(21.00,38.75)"},
        {"Variables": "y2", "Parametros": "p2", "Ecuaciones": ' dy2dt = (p4 / 2.7) * (y1 - y2)', " Condiciones Iniciales": ""},
        {"Variables": "t", "Parametros": "p3", "Ecuaciones": "f(t,y,y',p)= -(5.3/7.02*p4*y')- p1*y'"
                                                             "+ (p1*p4/2.7)*(27.8-y)+(1991/t^2)*((p4/2.7)*t-1-w/p3)*math.exp(-w^2/2)   ", "Condiciones Iniciales":""},
        { "Parametros": "p4",  }
    ],
    2:[
        {"Variables": [0, 0, 0], "Parametros": [0, 0, 0], "Ecuaciones": [0, 0, 0], "Condiciones Iniciales": [0, 0, 0]},
...
def modelo_enzi(z, t, p1, p2, p3, p4):
    ...
    y1 = z[0]
    y2=z[1]
    dy1dt = p1 * (27.8 - y1) + (p4 / 2.6) * (y2 - y1) + (4991 / t * math.sqrt(2 * math.pi)) * math.exp(-0.5*(math.log(t) - p2 / p3))
    dy2dt = (p4 / 2.7) * (y1 - y2)
